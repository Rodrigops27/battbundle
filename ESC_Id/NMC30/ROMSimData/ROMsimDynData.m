...
romsimdata_parent = fileparts(script_dir);  % ROMSimData/ -> NMC30/
nmc30_parent = fileparts(romsimdata_parent);  % NMC30/ -> ESC_Id/
esc_id_root = nmc30_parent;
...
if isempty(esc_model_file)
    ...
    error('ROMsimDynData:MissingESCModel', ...
        'No NMC30 full ESC model found. Searched:%s\nRun OCVNMC30fromROM.m and NMC30DynParIdROMsim.m first.', ...
        searched);
end
