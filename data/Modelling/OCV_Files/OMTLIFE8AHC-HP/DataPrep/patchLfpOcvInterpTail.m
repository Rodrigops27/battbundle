...
ocv_dir = fileparts(script_dir);
input_file = fullfile(ocv_dir,'LFP_OCV_interp.mat');
output_file = fullfile(ocv_dir,'LFP_OCV_interp_tailPatched.mat');

src = load(input_file,'OCV_interp');
