...
ensureDataRegistryLayout(repo_root, 'suite_versions', {'behavioral_nmc30_bss_v1'});
...
repo_root = inferRepoRoot(fileparts(mfilename('fullpath')));
end
...
if isempty(repo_root)
    error('createBusCoreBatterySyntheticDataset:MissingRepoRoot', ...
